...
AuctionUpdateProcess.prototype.updateAuction = function () {
    ...
    async.waterfall([
        ...
        function (region, realm, name, callback) {
            updateModel.insert("wp_gu", region, realm, name, 0, function (error) {
    ...
    async.waterfall([
        ...
        function (region, auctions, callback) {
            async.each(auctions, function (auction, callback) {
                updateModel.insert("wp_au", region, auction.ownerRealm, auction.owner, 0, function (error) {
        ...
        async.waterfall([
            ...
            function (realms, callback) {
                async.eachSeries(realms, function (realm, callback) {
                    updateModel.insert("wp_aru", region, "", realm.connected_realms[0], 0, function (error) {
